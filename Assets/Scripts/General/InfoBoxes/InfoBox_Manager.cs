...
public class InfoBox_Manager : MonoBehaviour
{
    ...
    private void loadInfo(string scene){
        ...
        if (scene == "Chat"){
            title = "Chat";
            body = "It's the first week of working on your game! Chat with your employees to get insights into their progress, be notified of any problems and determine their number of hours for the week.";
            size = sizes.large;
            prepared = true;
        }
